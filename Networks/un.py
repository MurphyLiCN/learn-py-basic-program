    ...
    for file in tqdm(os.listdir(os.path.join(path_dir, hs))):
        with open(os.path.join(path_dir, hs, file), 'r') as f:
            ...
            for r in reader:
                ...
                if r[0] == 'Result too large: you do not have permissions to access such a large resultset.':
                    break
...
if __name__ == '__main__':
    ...
    path_dir = r"C:\lmf\pythonProject\IndicatorUN\data"       # 须填写，例 C:\data

    # hs01的格式不一样，最后处理
    for hs in tqdm(range(99, 99)):
        fun(hs)
